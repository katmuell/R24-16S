...
akk_stats <- data.frame(total_samples = nsamples(people.ps.rel),
                       total_akk = nsamples(subset_samples(people.ps.rel, Akk_presence == "Akk_Positive")),
...
akk_stats
```
684/790 samples have an abundance of at least 0.01% Akkermansia from all three ASVs combined. 532 have an abundance of at least 0.01% AmI, 65 have an abundance of at least 0.01% Am2, and 87 have an abundance of at least 0.01% AmIV.
...
nsamples(subset_samples(obese.ps.rel, Akk_presence == "Akk_Positive"))

obese_stats <- c(no_akk = nsamples(subset_samples(obese.ps.rel, Akk_presence == "Akk_Negative")),
...
nsamples(subset_samples(healthy.ps.rel, Akk_presence == "Akk_Positive"))

healthy_stats <- c(no_akk = nsamples(subset_samples(healthy.ps.rel, Akk_presence == "Akk_Negative")),
