...
```{r}
nsamples(people.ps.rel)
nsamples(subset_samples(people.ps.rel, Akk_presence == "Akk_Positive"))
nsamples(subset_samples(people.ps.rel, AmI_presence == "AmI_Positive"))
nsamples(subset_samples(people.ps.rel, AmII_presence == "AmII_Positive"))
nsamples(subset_samples(people.ps.rel, AmIV_presence == "AmIV_Positive"))
nsamples(subset_samples(people.ps.rel, AmI_presence == "AmI_Positive" & AmII_presence == "AmII_Positive"))
nsamples(subset_samples(people.ps.rel, AmI_presence == "AmI_Positive" & AmIV_presence == "AmIV_Positive"))
nsamples(subset_samples(people.ps.rel, AmII_presence == "AmII_Positive" & AmIV_presence == "AmIV_Positive"))
```
...
44 samples contain both AmI and AmII at an abundance of at least 0.01% each. 51 samples contain both AmI and AmIV at at least 0.01% abundance each, and 1 sample contains both AmII and AmIV at at least 0.01% abundance each.
