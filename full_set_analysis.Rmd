...
nsamples(obese.ps.rel)
nsamples(subset_samples(obese.ps.rel, AmI_presence == "AmI_Positive" | AmII_presence == "AmII_Positive" | AmIV_presence == "AmIV_Positive"))

obese_stats <- c(no_akk = nsamples(subset_samples(obese.ps.rel, AmI_presence == "AmI_Negative" & AmII_presence == "AmII_Negative" & AmIV_presence == "AmIV_Negative")),
                          AmI = nsamples(subset_samples(obese.ps.rel, AmI_presence == "AmI_Positive")),
                          AmII = nsamples(subset_samples(obese.ps.rel, AmII_presence == "AmII_Positive")),
                          AmIV = nsamples(subset_samples(obese.ps.rel, AmIV_presence == "AmIV_Positive")),
                          AmI_AmII = nsamples(subset_samples(obese.ps.rel, AmI_presence == "AmI_Positive" & AmII_presence == "AmII_Positive")),
                          AMI_AmIV = nsamples(subset_samples(obese.ps.rel, AmI_presence == "AmI_Positive" & AmIV_presence == "AmIV_Positive")),
                          #The last one results in a non-zero dimensions error, indicating that there are no samples that satisfy these conditions
                          #nsamples(subset_samples(obese.ps.rel, AmII_presence == "AmII_Positive" & AmIV_presence == "AmIV_Positive"))
                          AmII_AmIV = 0)
obese_stats
```
```{r}
...
nsamples(healthy.ps.rel)
nsamples(subset_samples(healthy.ps.rel, AmI_presence == "AmI_Positive" | AmII_presence == "AmII_Positive" | AmIV_presence == "AmIV_Positive"))

healthy_stats <- c(no_akk = nsamples(subset_samples(healthy.ps.rel, AmI_presence == "AmI_Negative" & AmII_presence == "AmII_Negative" & AmIV_presence == "AmIV_Negative")),
                   AmI = nsamples(subset_samples(healthy.ps.rel, AmI_presence == "AmI_Positive")),
                   AmII = nsamples(subset_samples(healthy.ps.rel, AmII_presence == "AmII_Positive")),
                   AmIV = nsamples(subset_samples(healthy.ps.rel, AmIV_presence == "AmIV_Positive")),
                   AmI_AmII = nsamples(subset_samples(healthy.ps.rel, AmI_presence == "AmI_Positive" & AmII_presence == "AmII_Positive")),
                   AmI_AmIV = nsamples(subset_samples(healthy.ps.rel, AmI_presence == "AmI_Positive" & AmIV_presence == "AmIV_Positive")),
                   AmII_AmIV = nsamples(subset_samples(healthy.ps.rel, AmII_presence == "AmII_Positive" & AmIV_presence == "AmIV_Positive")))
healthy_stats
```

```{r}
akk_comps <- data.frame(obese = obese_stats, healthy = healthy_stats)
akk_comps
```
